...
export function ThesisStartPanel() {
  return (
    <section className="w-full max-w-3xl rounded-3xl border border-white/10 bg-white/[0.03] p-6 text-left shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8">
      <p className="text-[11px] font-medium uppercase tracking-[0.24em] text-amber-200/80">Thesis workspace</p>
      <h1 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-white sm:text-4xl">Open a thesis or start a new one.</h1>
